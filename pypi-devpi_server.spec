...
Version  : 6.15.0
Release  : 15
URL      : https://files.pythonhosted.org/packages/8b/a4/2f2bdc54710d05b0da09059821f6bbd4dcdfdc26b2a41ea095a9781d5aa6/devpi-server-6.15.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/8b/a4/2f2bdc54710d05b0da09059821f6bbd4dcdfdc26b2a41ea095a9781d5aa6/devpi-server-6.15.0.tar.gz
...
%prep
%setup -q -n devpi-server-6.15.0
cd %{_builddir}/devpi-server-6.15.0
pushd ..
cp -a devpi-server-6.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747667859
