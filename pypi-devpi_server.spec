...
Version  : 6.12.1
Release  : 10
URL      : https://files.pythonhosted.org/packages/c1/cd/722e084bc5dfb2a598d1dffb3fb178d6a50a2617bbdf5e4e49e7b369aa78/devpi-server-6.12.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/c1/cd/722e084bc5dfb2a598d1dffb3fb178d6a50a2617bbdf5e4e49e7b369aa78/devpi-server-6.12.1.tar.gz
...
%prep
%setup -q -n devpi-server-6.12.1
cd %{_builddir}/devpi-server-6.12.1
pushd ..
cp -a devpi-server-6.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721835230
