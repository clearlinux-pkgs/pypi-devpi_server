...
Version  : 6.16.0
Release  : 16
URL      : https://files.pythonhosted.org/packages/f4/0b/0d2c883ae022e64089a897e6cc7e0e4aa774026400041f2b6cbecdcdec4b/devpi_server-6.16.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/f4/0b/0d2c883ae022e64089a897e6cc7e0e4aa774026400041f2b6cbecdcdec4b/devpi_server-6.16.0.tar.gz
...
%prep
%setup -q -n devpi_server-6.16.0
cd %{_builddir}/devpi_server-6.16.0
pushd ..
cp -a devpi_server-6.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750884659
