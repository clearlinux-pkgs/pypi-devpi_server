...
Version  : 6.10.0
Release  : 6
URL      : https://files.pythonhosted.org/packages/1e/8c/f7910b42d79069a6913c2d6c064934b34d2cc316462a876eaa8be46937b7/devpi-server-6.10.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/1e/8c/f7910b42d79069a6913c2d6c064934b34d2cc316462a876eaa8be46937b7/devpi-server-6.10.0.tar.gz
...
%prep
%setup -q -n devpi-server-6.10.0
cd %{_builddir}/devpi-server-6.10.0
pushd ..
cp -a devpi-server-6.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703000260
