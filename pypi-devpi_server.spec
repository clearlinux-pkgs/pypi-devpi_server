...
Version  : 6.11.0
Release  : 8
URL      : https://files.pythonhosted.org/packages/cb/61/5e3ace38deba94752096d995e9ba36acae3dd95142be8df55a8888c5e8dd/devpi_server-6.11.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/cb/61/5e3ace38deba94752096d995e9ba36acae3dd95142be8df55a8888c5e8dd/devpi_server-6.11.0.tar.gz
...
%prep
%setup -q -n devpi_server-6.11.0
cd %{_builddir}/devpi_server-6.11.0
pushd ..
cp -a devpi_server-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713665304
...
cp %{_builddir}/devpi_server-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-devpi_server/cf3eaf29116a37a7d9ba773e776104c067c8e5fc || :
