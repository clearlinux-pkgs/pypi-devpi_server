...
Version  : 6.13.0
Release  : 11
URL      : https://files.pythonhosted.org/packages/1a/96/722081aec89931f3e7e97f1e91ad4baa79b150982abed22ab39d808a44ce/devpi-server-6.13.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/1a/96/722081aec89931f3e7e97f1e91ad4baa79b150982abed22ab39d808a44ce/devpi-server-6.13.0.tar.gz
...
%prep
%setup -q -n devpi-server-6.13.0
cd %{_builddir}/devpi-server-6.13.0
pushd ..
cp -a devpi-server-6.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726844612
