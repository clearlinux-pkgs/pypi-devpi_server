...
Version  : 6.12.0
Release  : 9
URL      : https://files.pythonhosted.org/packages/3d/09/9d5c3dfc33d9e6e37e6f393744f0558aaaad4abb45b33f7c789a849eee41/devpi_server-6.12.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/3d/09/9d5c3dfc33d9e6e37e6f393744f0558aaaad4abb45b33f7c789a849eee41/devpi_server-6.12.0.tar.gz
...
%prep
%setup -q -n devpi_server-6.12.0
cd %{_builddir}/devpi_server-6.12.0
pushd ..
cp -a devpi_server-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719329429
